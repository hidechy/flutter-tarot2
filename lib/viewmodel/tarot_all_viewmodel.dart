...
import '../state/tarot_all_state.dart';

final tarotAllProvider =
    StateNotifierProvider.autoDispose<TarotAllNotifier, TarotAllState>((ref) {
  final client = ref.read(httpClientProvider);

  return TarotAllNotifier(
    const TarotAllState(record: {}),
    client,
  )..getAllTarot();
});

class TarotAllNotifier extends StateNotifier<TarotAllState> {
  TarotAllNotifier(super.state, this.client);
