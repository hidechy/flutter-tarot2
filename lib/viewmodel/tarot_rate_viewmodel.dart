...
final tarotRateProvider = StateNotifierProvider.autoDispose
    .family<TarotRateNotifier, TarotRateState, String>((ref, category) {
...
class TarotRateNotifier extends StateNotifier<TarotRateState> {
  ...
  Future<void> getTarotRate({required String category}) async {
    await client.post(
        path: 'getCategoryRate', body: {'category': category}).then((value) {
